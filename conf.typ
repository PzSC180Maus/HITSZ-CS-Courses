...
#let conf(doc, color-theme: "blue", eq-level: 1, fig-image-level: 1, math-fun-level: 1) = {
  ...
  show emph: set text(font: ("Times New Roman", "Kaiti SC"))
  show strong: set text(font: ("Times New Roman", "PingFang SC"))
  show text.where(weight: "bold"): set text(font: ("Times New Roman", "PingFang SC"))
